...
public class partidos_playoffs extends partidos {
    ...
    public partidos_playoffs(String equipo_local, String equipo_visitante, int cestas_local, int cestas_visitante, boolean finalizo, Date fecha_partido, String ronda) {
    ...
    public String infoPartido() {
        return "Equipo local: " + equipo_local + " | Equipo visitante: " + equipo_visitante + " | Cestas local: " + cestas_local + " | Cestas visitante: " + cestas_visitante + " | Fecha: " + fecha_partido + " | Jornada: " + ronda;
    }
}